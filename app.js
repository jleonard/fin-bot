...
passport.use(new GoogleStrategy({
  ...
  function(accessToken, refreshToken, profile, done) {
    ...
    models.user.findOrCreate({ id: mongoose.Types.ObjectId(profile.id.toString()), familyName: profile.name.familyName, givenName: profile.name.givenName, icon: icon }, function (err, user, created) {
